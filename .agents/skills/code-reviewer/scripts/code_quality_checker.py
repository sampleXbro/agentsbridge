...
Usage:
    python .agents/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .agents/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .agents/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
