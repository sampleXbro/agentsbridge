...
Usage:
    python .agents/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .agents/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .agents/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
