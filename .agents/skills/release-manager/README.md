...
### .agents/skills/release-manager/changelog_generator.py
...
### .agents/skills/release-manager/version_bumper.py
...
### .agents/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .agents/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.agents/skills/release-manager/SKILL.md](.agents/skills/release-manager/SKILL.md).
