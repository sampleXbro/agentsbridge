...
| -------------- | ------------------------------ | ------------------------------------------------------------ |
| Advanced Types | `.agents/skills/typescript-pro/references/advanced-types.md` | Generics, conditional types, mapped types, template literals |
| Type Guards    | `.agents/skills/typescript-pro/references/type-guards.md`    | Type narrowing, discriminated unions, assertion functions    |
| Utility Types  | `.agents/skills/typescript-pro/references/utility-types.md`  | Partial, Pick, Omit, Record, custom utilities                |
| Configuration  | `.agents/skills/typescript-pro/references/configuration.md`  | tsconfig options, strict mode, project references            |
| Patterns       | `.agents/skills/typescript-pro/references/patterns.md`       | Builder pattern, factory pattern, type-safe APIs             |
