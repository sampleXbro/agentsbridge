...
`.agentsmesh/skills/code-reviewer/references/code_review_checklist.md`
...
### Coding Standards
`.agentsmesh/skills/code-reviewer/references/coding_standards.md`
...
### Common Antipatterns
`.agentsmesh/skills/code-reviewer/references/common_antipatterns.md`
