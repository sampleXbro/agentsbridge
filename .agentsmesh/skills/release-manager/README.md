...
### .agentsmesh/skills/release-manager/changelog_generator.py
...
### .agentsmesh/skills/release-manager/version_bumper.py
...
### .agentsmesh/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .agentsmesh/skills/release-manager/SKILL.md
