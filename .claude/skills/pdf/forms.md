...
- Run this script from this file's directory: `python .agentsmesh/packs/anthropics-skills-pdf/skills/pdf/scripts/extract_form_field_info.py <input.pdf> <field_info.json>`. It will create a JSON file with a list of fields in this format:
```
[
  {
...
`python .agentsmesh/packs/anthropics-skills-pdf/skills/pdf/scripts/convert_pdf_to_images.py <file.pdf> <output_directory>`
...
`python .agentsmesh/packs/anthropics-skills-pdf/skills/pdf/scripts/fill_fillable_fields.py <input pdf> <field_values.json> <output pdf>`
...
`python .agentsmesh/packs/anthropics-skills-pdf/skills/pdf/scripts/extract_form_structure.py <input.pdf> form_structure.json`
...
`python .agentsmesh/packs/anthropics-skills-pdf/skills/pdf/scripts/check_bounding_boxes.py fields.json`
...
`python .agentsmesh/packs/anthropics-skills-pdf/skills/pdf/scripts/convert_pdf_to_images.py <input.pdf> <images_dir/>`
...
`python .agentsmesh/packs/anthropics-skills-pdf/skills/pdf/scripts/fill_pdf_form_with_annotations.py <input.pdf> fields.json <output.pdf>`

## Step 4: Verify Output

Convert the filled PDF to images and verify text placement:
`python .agentsmesh/packs/anthropics-skills-pdf/skills/pdf/scripts/convert_pdf_to_images.py <output.pdf> <verify_images/>`
