...
### .claude/skills/release-manager/changelog_generator.py
...
### .claude/skills/release-manager/version_bumper.py
...
### .claude/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .claude/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.claude/skills/release-manager/SKILL.md](.claude/skills/release-manager/SKILL.md).
