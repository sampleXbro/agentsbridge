...
`.cline/skills/code-reviewer/references/code_review_checklist.md`
...
### Coding Standards
`.cline/skills/code-reviewer/references/coding_standards.md`
...
### Common Antipatterns
`.cline/skills/code-reviewer/references/common_antipatterns.md`
