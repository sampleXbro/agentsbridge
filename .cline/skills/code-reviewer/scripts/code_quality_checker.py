...
Usage:
    python .cline/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .cline/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .cline/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
