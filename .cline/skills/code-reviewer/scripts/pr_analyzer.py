...
Usage:
    python .cline/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .cline/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .cline/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
