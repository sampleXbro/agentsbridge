...
### .cline/skills/release-manager/changelog_generator.py
...
### .cline/skills/release-manager/version_bumper.py
...
### .cline/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .cline/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.cline/skills/release-manager/SKILL.md](.cline/skills/release-manager/SKILL.md).
