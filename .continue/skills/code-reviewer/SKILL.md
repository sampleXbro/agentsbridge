...
`.continue/skills/code-reviewer/references/code_review_checklist.md`
...
### Coding Standards
`.continue/skills/code-reviewer/references/coding_standards.md`
...
### Common Antipatterns
`.continue/skills/code-reviewer/references/common_antipatterns.md`
