...
Usage:
    python .continue/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .continue/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .continue/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
