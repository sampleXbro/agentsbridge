...
Usage:
    python .continue/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .continue/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .continue/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
