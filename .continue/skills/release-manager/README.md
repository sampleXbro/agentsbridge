...
### .continue/skills/release-manager/changelog_generator.py
...
### .continue/skills/release-manager/version_bumper.py
...
### .continue/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .continue/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.continue/skills/release-manager/SKILL.md](.continue/skills/release-manager/SKILL.md).
