...
`.cursor/skills/code-reviewer/references/code_review_checklist.md`
...
### Coding Standards
`.cursor/skills/code-reviewer/references/coding_standards.md`
...
### Common Antipatterns
`.cursor/skills/code-reviewer/references/common_antipatterns.md`
