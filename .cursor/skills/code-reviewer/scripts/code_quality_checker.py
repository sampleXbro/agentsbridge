...
Usage:
    python .cursor/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .cursor/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .cursor/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
