...
Usage:
    python .cursor/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .cursor/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .cursor/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
