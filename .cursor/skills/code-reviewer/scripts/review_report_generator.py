...
Usage:
    python .cursor/skills/code-reviewer/scripts/review_report_generator.py /path/to/repo
    python .cursor/skills/code-reviewer/scripts/review_report_generator.py . --pr-analysis pr_results.json --quality-analysis quality_results.json
    python .cursor/skills/code-reviewer/scripts/review_report_generator.py /path/to/repo --format markdown --output review.md
"""
...
def run_pr_analyzer(repo_path: Path) -> Dict:
    """Run .cursor/skills/code-reviewer/scripts/pr_analyzer.py and return results."""
    script_path = Path(__file__).parent / ".cursor/skills/code-reviewer/scripts/pr_analyzer.py"
    if not script_path.exists():
        return {"status": "error", "message": ".cursor/skills/code-reviewer/scripts/pr_analyzer.py not found"}
...
def run_quality_checker(repo_path: Path) -> Dict:
    """Run .cursor/skills/code-reviewer/scripts/code_quality_checker.py and return results."""
    script_path = Path(__file__).parent / ".cursor/skills/code-reviewer/scripts/code_quality_checker.py"
    if not script_path.exists():
        return {"status": "error", "message": ".cursor/skills/code-reviewer/scripts/code_quality_checker.py not found"}
