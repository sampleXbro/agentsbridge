...
### .cursor/skills/release-manager/changelog_generator.py
...
### .cursor/skills/release-manager/version_bumper.py
...
### .cursor/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .cursor/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.cursor/skills/release-manager/SKILL.md](.cursor/skills/release-manager/SKILL.md).
