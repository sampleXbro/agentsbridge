...
Usage:
    python .gemini/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .gemini/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .gemini/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
