...
Usage:
    python .gemini/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .gemini/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .gemini/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
