...
### .gemini/skills/release-manager/changelog_generator.py
...
### .gemini/skills/release-manager/version_bumper.py
...
### .gemini/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .gemini/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.gemini/skills/release-manager/SKILL.md](.gemini/skills/release-manager/SKILL.md).
