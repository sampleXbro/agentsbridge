...
`.github/skills/code-reviewer/references/code_review_checklist.md`
...
### Coding Standards
`.github/skills/code-reviewer/references/coding_standards.md`
...
### Common Antipatterns
`.github/skills/code-reviewer/references/common_antipatterns.md`
