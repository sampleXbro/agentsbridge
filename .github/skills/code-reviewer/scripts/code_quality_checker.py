...
Usage:
    python .github/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .github/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .github/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
