...
Usage:
    python .github/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .github/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .github/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
