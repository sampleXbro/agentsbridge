...
### .github/skills/release-manager/changelog_generator.py
...
### .github/skills/release-manager/version_bumper.py
...
### .github/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .github/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.github/skills/release-manager/SKILL.md](.github/skills/release-manager/SKILL.md).
