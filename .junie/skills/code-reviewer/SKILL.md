...
`.junie/skills/code-reviewer/references/code_review_checklist.md`
...
### Coding Standards
`.junie/skills/code-reviewer/references/coding_standards.md`
...
### Common Antipatterns
`.junie/skills/code-reviewer/references/common_antipatterns.md`
