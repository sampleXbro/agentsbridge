...
Usage:
    python .junie/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .junie/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .junie/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
