...
Usage:
    python .junie/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .junie/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .junie/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
