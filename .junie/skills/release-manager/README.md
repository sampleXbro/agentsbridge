...
### .junie/skills/release-manager/changelog_generator.py
...
### .junie/skills/release-manager/version_bumper.py
...
### .junie/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .junie/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.junie/skills/release-manager/SKILL.md](.junie/skills/release-manager/SKILL.md).
