...
`.kiro/skills/code-reviewer/references/code_review_checklist.md`
...
### Coding Standards
`.kiro/skills/code-reviewer/references/coding_standards.md`
...
### Common Antipatterns
`.kiro/skills/code-reviewer/references/common_antipatterns.md`
