...
Usage:
    python .kiro/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .kiro/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .kiro/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
