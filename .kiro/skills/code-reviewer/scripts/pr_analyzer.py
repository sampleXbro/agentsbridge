...
Usage:
    python .kiro/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .kiro/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .kiro/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
