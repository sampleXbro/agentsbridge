...
### .kiro/skills/release-manager/changelog_generator.py
...
### .kiro/skills/release-manager/version_bumper.py
...
### .kiro/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .kiro/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.kiro/skills/release-manager/SKILL.md](.kiro/skills/release-manager/SKILL.md).
