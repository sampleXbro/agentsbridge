...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run .kiro/skills/security-ownership-map/scripts/build_ownership_map.py with sensible defaults."
    )
...
def main() -> int:
    ...
    script_path = Path(__file__).resolve().parent / ".kiro/skills/security-ownership-map/scripts/build_ownership_map.py"
    cmd = [
        sys.executable,
        str(script_path),
        "--repo",
