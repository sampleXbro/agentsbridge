...
Usage:
    python .roo/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .roo/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .roo/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
