...
Usage:
    python .roo/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .roo/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .roo/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
