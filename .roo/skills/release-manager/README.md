...
### .roo/skills/release-manager/changelog_generator.py
...
### .roo/skills/release-manager/version_bumper.py
...
### .roo/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .roo/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.roo/skills/release-manager/SKILL.md](.roo/skills/release-manager/SKILL.md).
