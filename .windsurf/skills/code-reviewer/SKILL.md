...
`.windsurf/skills/code-reviewer/references/code_review_checklist.md`
...
### Coding Standards
`.windsurf/skills/code-reviewer/references/coding_standards.md`
