...
Usage:
    python .windsurf/skills/code-reviewer/scripts/code_quality_checker.py /path/to/file.py
    python .windsurf/skills/code-reviewer/scripts/code_quality_checker.py /path/to/directory --recursive
    python .windsurf/skills/code-reviewer/scripts/code_quality_checker.py . --language typescript --json
"""
