...
Usage:
    python .windsurf/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo
    python .windsurf/skills/code-reviewer/scripts/pr_analyzer.py . --base main --head feature-branch
    python .windsurf/skills/code-reviewer/scripts/pr_analyzer.py /path/to/repo --json
"""
