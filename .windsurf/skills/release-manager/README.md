...
### .windsurf/skills/release-manager/changelog_generator.py
...
### .windsurf/skills/release-manager/version_bumper.py
...
### .windsurf/skills/release-manager/release_planner.py
...
3. **Update documentation** including this README and .windsurf/skills/release-manager/SKILL.md
...
For detailed methodology and background information, see [.windsurf/skills/release-manager/SKILL.md](.windsurf/skills/release-manager/SKILL.md).
