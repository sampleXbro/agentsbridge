 ...
 *
 * Rovo Dev does not support hooks, permissions, or ignore as standalone
...
export function lintHooks(canonical: CanonicalFiles): LintDiagnostic[] {
  ...
  return [
    createWarning(
      ...
      'rovodev',
      'Rovo Dev has no lifecycle hook system; canonical hooks are not projected.',
    ),
  ];
}
...
export function lintPermissions(canonical: CanonicalFiles): LintDiagnostic[] {
  ...
  return [
    createWarning(
      ...
      'rovodev',
      'Rovo Dev permissions are managed in config.yaml; canonical permissions are not projected.',
    ),
  ];
}
