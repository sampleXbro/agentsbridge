...
import { generateRules, generateSkills, generateMcp, generateIgnore } from './generator.js';
...
const project: TargetLayout = {
  ...
  managedOutputs: {
    dirs: [TRAE_RULES_DIR, TRAE_SKILLS_DIR],
...
const global: TargetLayout = {
  ...
  managedOutputs: {
    dirs: [TRAE_GLOBAL_RULES_DIR, TRAE_GLOBAL_SKILLS_DIR, TRAE_GLOBAL_AGENTS_SKILLS_DIR],
