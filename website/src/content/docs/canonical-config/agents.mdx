...
| Tool | Support | Notes |
|------|---------|-------|
| Claude Code | Native | Maps directly to Claude Code agent format. |
| Cursor | Native | Maps to Cursor agent definition format. |
| Copilot | Native | Maps to Copilot agent definition. |
| Gemini CLI | Native | Maps to Gemini CLI agent format. |
| Cline | Embedded | Projected as a skill with metadata for round-trip. |
| Codex CLI | Native | Maps to Codex CLI agent format. |
| Windsurf | Embedded | Projected as a skill with metadata. |
