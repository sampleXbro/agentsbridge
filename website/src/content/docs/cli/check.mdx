...
The MCP `check` tool mirrors this in its result payload, exposing `outputsModified`, `outputsRemoved`, and `outputsChecked` alongside the canonical-drift fields.
