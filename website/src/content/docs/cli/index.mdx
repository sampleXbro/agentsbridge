...
draft: false
title: CLI Reference
description: Complete reference for all AgentsMesh CLI commands — init, generate, import, convert, install, diff, lint, watch, check, merge, matrix, plugin, and target. Both project and global mode supported.
sidebar:
  label: Overview
  order: 0
---
