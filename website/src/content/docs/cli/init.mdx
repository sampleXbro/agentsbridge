...
| `--lessons` | Scaffold the project-level lessons recall + capture subsystem: inject the always-on trigger into `_root.md` and seed the `lessons` skill manual under `skills/lessons/`. Cannot be combined with `--global`. |
