...
See the [supported tools matrix](../../reference/supported-tools/) for every valid built-in target ID. Plugin targets installed via `agentsmesh plugin add` are also valid.
