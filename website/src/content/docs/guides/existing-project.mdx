...
1. **Initialize the canonical directory**
   ...
   On a terminal this launches a short [wizard](../../cli/init/#interactive-wizard) that scans the project and offers to import detected configs, then lets you pick targets. Use `--yes` to skip the wizard and import everything non-interactively:
