...
| Antigravity | `~/.gemini/GEMINI.md` (rules embedded), `~/.gemini/config/skills/`, `~/.gemini/antigravity/global_workflows/`, `~/.gemini/config/mcp_config.json`, `~/.gemini/config/hooks.json` | Same user-level paths |
